* 2021_cross_eu_silc_h_ver_2023_release2_v2.do 
*
...
*
* Pforr, Klaus, Johanna Jung and Carl Riemann (2024): 2021_cross_eu_silc_h_ver_2023_release2_v2.do, 1st update.
...
label variable HY022_IF "imp. factor" ;
...
label variable HY060G_IF "imp. factor" ;
...
label variable HY061G_IF "imp. factor" ;
...
label variable HY062G_IF "imp. factor" ;
...
label variable HY063G_IF "imp. factor" ;
...
label variable HY155G_1_IF "imp. factor" ;
label variable HY155G_2_IF "imp. factor" ;
label variable HY155G_3_IF "imp. factor" ;
label variable HY155G_4_IF "imp. factor" ;
...
label variable HI012 "Change in income as an outcome of Covid-19 (Optional)" ;
...
label variable HI040 "Expectation of the Household income in the next 12 Months" ;
...
31 "deduc./logic. imp. (incl. top/bot-coding), Net of tax on income at source and social contributions"
32 "deduc./logic. imp. (incl. top/bot-coding), Net of tax on income at source"
...
42 "Gross/net conversion, Net of tax on income at source"
...
51 "Model-based imp., Net of tax on income at source and social contributions"
52 "Model-based imp., Net of tax on income at source"
53 "Model-based imp., Net of social contributions"
54 "Model-based imp., Mix of different nets"
55 "Model-based imp., Gross"
56 "Model-based imp., Income component(s) not taxed"
57 "Model-based imp., Mix of net and gross"
58 "Model-based imp., Unknown"
59 "Model-based imp., Not applicable/not collected"
61 "Donor imp., Net of tax on income at source and social contributions"
62 "Donor imp., Net of tax on income at source"
63 "Donor imp., Net of social contributions"
64 "Donor imp., Mix of different nets"
65 "Donor imp., Gross"
66 "Donor imp., Income component(s) not taxed"
67 "Donor imp., Mix of net and gross"
68 "Donor imp., Unknown"
69 "Donor imp., Not applicable/not collected"
71 "Not poss. to estab. m. comm. source/method, Net of tax on income at source and social contributions"
72 "Not poss. to estab. m. comm. source/method, Net of tax on income at source"
...
121 "Collected via survey/interview, Net of tax on income at source, only contrib & means-tested components"
122 "Collected via survey/interview, Net of tax on income at source, mixed components"
...
221 "Collected from administrative data, Net of tax on income at source, only contrib & means-tested components"
222 "Collected from administrative data, Net of tax on income at source, mixed components"
...
321 "deduc./logic. imp. (incl. top/bot-coding), Net of tax on income at source, only contrib & means-tested components"
322 "deduc./logic. imp. (incl. top/bot-coding), Net of tax on income at source, mixed components"
...
361 "Deduct./logical imp (incl. top-/bottom-cod), Income comp not taxed, only contrib and means-tested components"
...
391 "Deduct./logical imp (incl. top-/bottom-cod), Not applic/not collected, only contrib and means-tested components"
...
421 "Gross/net conversion, Net of tax on income at source, only contrib & means-tested components"
422 "Gross/net conversion, Net of tax on income at source, mixed components"
...
511 "Model-based imp., Net of income tax & social contrib, only contrib & means-tested components"
512 "Model-based imp., Net of income tax & social contrib, mixed components"
521 "Model-based imp., Net of tax on income at source, only contrib & means-tested components"
522 "Model-based imp., Net of tax on income at source, mixed components"
531 "Model-based imp., Net of social contrib, only contrib & means-tested components"
532 "Model-based imp., Net of social contrib, mixed components"
541 "Model-based imp., Mix of different nets, only contrib & means-tested components"
542 "Model-based imp., Mix of different nets, mixed components"
551 "Model-based imp., Gross, only contributory and means-tested components"
552 "Model-based imp., Gross, mixed components"
561 "Model-based imp., Income comp not taxed, only contributory and means-tested components"
562 "Model-based imp., Income comp not taxed, mixed components"
571 "Model-based imp., Mix of net and gross, only contrib & means-tested components"
572 "Model-based imp., Mix of net and gross, mixed components"
581 "Model-based imp., Unknown, only contrib & means-tested components"
582 "Model-based imp., Unknown, mixed components"
591 "Model-based imp., Not applic/not collected, only contrib & means-tested components"
592 "Model-based imp., Not applic/not collected, mixed components"
611 "Donor imp., Net of income tax & social contrib, only contrib & means-tested components"
612 "Donor imp., Net of income tax & social contrib, mixed components"
621 "Donor imp., Net of tax on income at source, only contrib & means-tested components"
622 "Donor imp., Net of tax on income at source, mixed components"
631 "Donor imp., Net of social contrib, only contrib & means-tested components"
632 "Donor imp., Net of social contrib, mixed components"
641 "Donor imp., Mix of different nets, only contrib & means-tested components"
642 "Donor imp., Mix of different nets, mixed components"
651 "Donor imp., Gross, only contributory and means-tested components"
652 "Donor imp., Gross, mixed components"
661 "Donor imp., Income comp not taxed, only contributory and means-tested components"
662 "Donor imp., Income comp not taxed, mixed components"
671 "Donor imp., Mix of net and gross, only contributory and means-tested components"
672 "Donor imp., Mix of net and gross, mixed components"
681 "Donor imp., Unknown, only contrib & means-tested components"
682 "Donor imp., Unknown, mixed components"
691 "Donor imp., Not applic/not collected, only contributory and means-tested components"
692 "Donor imp., Not applic/not collected, mixed components"
...
721 "Not poss. to estab. m. comm. source/method, Net of tax on income at source, only contrib & means-tested comp"
722 "Not poss. to estab. m. comm. source/method, Net of tax on income at source, mixed components"
...
341 "deduc./logic. imp. (incl. top/bot-coding), Mix of different nets, only contrib & means-tested components"
342 "deduc./logic. imp. (incl. top/bot-coding), Mix of different nets, mixed components"
351 "Deduct./logic. imp. (incl. top-/bot-coding), Gross, only contributory and means-tested components"
352 "deduc./logic. imp. (incl. top/bot-coding), Gross, mixed components"
361 "Deduct./logic. imp. (incl. top-/bot-coding), Income comp not taxed, only contrib and means-tested components"
362 "deduc./logic. imp. (incl. top/bot-coding), Income comp not taxed, mixed components"
371 "deduc./logic. imp. (incl. top/bot-coding), Mix of net and gross, only contrib & means-tested components"
372 "deduc./logic. imp. (incl. top/bot-coding), Mix of net and gross, mixed components"
381 "deduc./logic. imp. (incl. top/bot-coding), Unknown, only contrib & means-tested components"
382 "deduc./logic. imp. (incl. top/bot-coding), Unknown, mixed components"
391 "Deduct./logic. imp. (incl. top-/bot-coding), Not applic/not collected, only contrib and means-tested components"
392 "deduc./logic. imp. (incl. top/bot-coding), Not applic/not collected, mixed components"
411 "Gross/net conversion, Net of income tax & social contrib, only contrib & means-tested components"
412 "Gross/net conversion, Net of tax on income at source and social contributions, mixed components"
421 "Gross/net conversion, Net of tax on income at source, only contrib & means-tested components"
...
11 "Collected via survey/interview, Net of tax on income at source and social contributions"
21 "Collected from administrative data, Net of tax on income at source and social contributions"
31 "Deductive/logical imp. (incl. top- and bottom-coding), Net of tax on income at source and social contributions"
41 "Gross/net conversion, Net of tax on income at source and social contributions"
51 "Model-based imp., Net of tax on income at source and social contributions"
61 "Donor imp., Net of tax on income at source and social contributions"
...
39 "Deductive/logical imp. (incl. top- and bottom-coding), Not applicable (the value was not collected)"
49 "Gross/net conversion, Not applicable (the value was not collected)"
59 "Model-based imp., Not applicable (the value was not collected)"
69 "Donor imp., Not applicable (the value was not collected)"
79 "Not possible to establish the most common source or method, Not applicable (the value was not collected)"
25 "DK: value not defined in data documentation"
;
...
label define HI012_F_VALUE_LABELS
  ...
  -7 "Not applicable (HB010 not = 2020, 2021)"
  -8 "Not applicable (variable not collected)"
;
...
-7 "Not applicable (HB010 is not 2021)"
-8 "Not applicable (variable not collected)"
;
...
label define HI130G_F_VALUE_LABELS
  ...
  31 "Deductive/logical imp."
  39 "Deductive/logical imp."
...
label define HY155G_F_VALUE_LABELS
   ...
   21 "Collected from administrative data & Net of tax on income at source and social contributions"
   29 "Collected from administrative data & Not applicable (the value was not collected)"
   31 "Deductive/logical imp. & Net of tax on income at source and social contributions"
   39 "Deductive/logical imp. & Not applicable (the value was not collected)"
   41 "Gross/net conversion & Net of tax on income at source and social contributions"
   49 "Gross/net conversion & Not applicable (the value was not collected)"
   51 "Model-based imp. & Net of tax on income at source and social contributions"
   59 "Model-based imp. & Not applicable (the value was not collected)"
