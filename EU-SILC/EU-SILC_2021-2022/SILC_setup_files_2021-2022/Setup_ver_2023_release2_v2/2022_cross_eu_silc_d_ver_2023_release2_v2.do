* 2022_cross_eu_silc_d_ver_2023_release2_v2.do 
*
...
* Country files are delivered in the format UDB_c*country_stub*22D.csv
* 
* (c) GESIS 2024-07-08
*
* PLEASE NOTE
...
*
* Pforr, Klaus, Johanna Jung and Carl Riemann (2024): 2022_cross_eu_silc_d_ver_2023_release2_v2.do, 1st update.
...
local log_file "$log/eusilc_2022_d" ;
...
local stata_file "$log/eusilc_2022_d_cs" ;
...
foreach CC in AT BE BG /*CH*/ CY CZ DE DK EE EL ES FI FR HR HU IE /*IS*/ IT LT LU LV MT NL /*NO*/ PL PT RO /*RS*/ SE SI SK /*UK*/ { ;
      cd "$csv_path/`CC'/2022" ;		
	  import delimited using "UDB_c`CC'22D.csv", case(upper) asdouble clear stringcols(2 4);
...
label variable DB100 "Degree of urbanisation (NL, SI: missing; DE, EE, LV:1,2 = 1)" ;
...
1 "Cities (DB010>=2021), Densely populated area (EE,LV:1,2=1) (DB010<2021)"
2 "Towns and suburbs (MT:2,3=2) (DB010>=2021), Intermediate area (MT:2,3=2) (DB010<2021)"
3 "Rural areas (DB010>=2021), Thinly populated area (DB010<2021)"
;
...
label data "Household register file 2022" ;
